                    ...
                    <div class="carousel-testimony owl-carousel">
                        <div class="item">
                            <div class="testimony-wrap d-flex">
                                <div class="user-img mr-4" style="background-image: url(images/teacher.jpg)">
                                </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="ftco-footer-widget mb-5">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            ...
                            <div class="text">
                                <h3 class="heading"><a href="#">The An-nur SCHOLARS’ Academy aims to provide
                                        a structured, purposeful and caring learning environment for all its pupils,</a>
                                </h3>
                                <div class="meta">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="ftco-footer-widget mb-5 ml-md-4">
                        <h2 class="ftco-heading-2">Quicks Links</h2>
                        <ul class="list-unstyled">
                            <li><a href="#"><span class="ion-ios-arrow-round-forward mr-2"></span>Home</a></li>
                            <li><a href="#"><span class="ion-ios-arrow-round-forward mr-2"></span>About</a></li>
                            < </ul> </div> </div> <div class="col-sm-6 col-md-3">
                                <div class="ftco-footer-widget mb-5">
                                    <h2 class="ftco-heading-2 mb-0">Follow us on social media</h2>
